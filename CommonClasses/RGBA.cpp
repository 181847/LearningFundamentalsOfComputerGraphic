...
const RGBA			RGBA::RED							= RGBA(RGBA::MAX_CHANNEL_VALUE, RGBA::MIN_CHANNEL_VALUE, RGBA::MIN_CHANNEL_VALUE, RGBA::ALPHA_CHANNEL_OPAQUE);
const RGBA			RGBA::GREEN							= RGBA(RGBA::MIN_CHANNEL_VALUE, RGBA::MAX_CHANNEL_VALUE, RGBA::MIN_CHANNEL_VALUE, RGBA::ALPHA_CHANNEL_OPAQUE);
const RGBA			RGBA::BLUE							= RGBA(RGBA::MIN_CHANNEL_VALUE, RGBA::MIN_CHANNEL_VALUE, RGBA::MAX_CHANNEL_VALUE, RGBA::ALPHA_CHANNEL_OPAQUE);
const RGBA			RGBA::YELLOW						= RGBA(RGBA::MAX_CHANNEL_VALUE, RGBA::MAX_CHANNEL_VALUE, RGBA::MIN_CHANNEL_VALUE, RGBA::ALPHA_CHANNEL_OPAQUE);
const RGBA			RGBA::CYAN							= RGBA(RGBA::MIN_CHANNEL_VALUE, RGBA::MAX_CHANNEL_VALUE, RGBA::MAX_CHANNEL_VALUE, RGBA::ALPHA_CHANNEL_OPAQUE);
const RGBA			RGBA::MAGENTA						= RGBA(RGBA::MAX_CHANNEL_VALUE, RGBA::MIN_CHANNEL_VALUE, RGBA::MAX_CHANNEL_VALUE, RGBA::ALPHA_CHANNEL_OPAQUE);
const RGBA			RGBA::BLACK							= RGBA(RGBA::MIN_CHANNEL_VALUE, RGBA::MIN_CHANNEL_VALUE, RGBA::MIN_CHANNEL_VALUE, RGBA::ALPHA_CHANNEL_OPAQUE);
const RGBA			RGBA::WHITE							= RGBA(RGBA::MAX_CHANNEL_VALUE, RGBA::MAX_CHANNEL_VALUE, RGBA::MAX_CHANNEL_VALUE, RGBA::ALPHA_CHANNEL_OPAQUE);
